  ...
  <nav class="task-navigation">
    <div class="nav-container">
      ...
      >
        ...
        <svg v-if="tab.name === 'Scheduled'" class="tab-icon" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
...
const taskTabs = [
  ...
  { name: 'Scheduled', path: '/tasks/scheduled' },
