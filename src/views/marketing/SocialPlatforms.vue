    ...
    <div class="marketing-cards-container">
      <div class="marketing-card">
        <div class="marketing-card-content">
          <h3 class="marketing-card-title">Social Media Platforms</h3>
          <p class="marketing-card-description">Coming soon! Connect and manage your social media accounts here.</p>
        </div>
      </div>
    </div>
  </div>
