...
.agents-hero__subtitle {
  font-size: 1.25rem;
  color: #0052a5;
  font-weight: 500;
}
.agents-benefits__container {
  max-width: 1100px;
  margin: 0 auto;
  padding: 40px 16px 32px 16px;
  text-align: center;
}
.agents-benefits__container h2 {
  font-size: 2rem;
  font-weight: 700;
  color: #003366;
...
.agents-cta__content h2 {
  font-size: 2rem;
  font-weight: 700;
  margin-bottom: 0.7rem;
}
.agents-cta__content p {
  font-size: 1.1rem;
  margin-bottom: 1.2rem;
}
.agents-cta__button {
